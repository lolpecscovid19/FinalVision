    ...
    public CommandLineRunner loadData(SamplePersonRepository samplePersonRepository) {
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 4, 6, 0, 0, 0));
            ...
            samplePersonRepositoryGenerator.setData(SamplePerson::setAge, DataType.NUMBER_UP_TO_100);
            ...
            samplePersonRepositoryGenerator.setData(SamplePerson::setDateOfVaccination, DataType.DATE_LAST_30_DAYS);
